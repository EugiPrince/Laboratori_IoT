...
from mqtt_subscriber import myMQTTSubscriber
...
if __name__ == "__main__":
    ...
    #Per testare il funzionamento, tramite il Client sviluppato precedentemente simuliamo la registrazione del device
    infoDevice = {"device_id": "Yun",
                  "resources": ["sensore temperatura"],
