...
#VERSIONE PER ESERCIZIO 4 (METODO getDevice leggermente differente e aggiunta in fondo una funzione per effettuare il refresh della temperatura)
class Catalog():
    ...
    def getDevice(self, device_id):
        return self.devices.get(device_id) if self.devices.get(device_id) else None
